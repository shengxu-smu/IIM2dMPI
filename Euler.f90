MODULE Euler
  ...
  DOUBLE PRECISION, DIMENSION(:,:),  ALLOCATABLE:: p,rhsp,d,dn
  ...
  INTEGER*2, DIMENSION(:,:), ALLOCATABLE:: icjc,ifjc,icjf,ickc,ifkc,ickf,jckc,jfkc,jckf
