MODULE para
  ...
  ! (sub)domain and grid
  INTEGER:: nx,ny,nxghost,nyghost,nseparate
  ...
  ! time-marching
  INTEGER:: nstart,nend,nstep
  DOUBLE PRECISION:: t,dt,cflc,cflv,dtcfl,dt0,dt1,dt2,tout,t0
  ...
  INTEGER:: uitype,ujtype,vitype,vjtype,objtype,pitype,pjtype
